...
public class ScoreboardAPI extends ScoreboardBase<String> {
    ...
    static {
        try {
            ...
            Class<?> craftChatMessageClass = ReflectionUtility.obcClass("util.CraftChatMessage");
    ...
    public void setDisplayName(final String displayName) {
        Objects.requireNonNull(displayName, "title");

        if (!VersionType.V1_20.isHigherOrEqual() && displayName.length() > 32) {
    ...
    protected boolean hasLinesMaxLength() {
        return !VersionType.V1_20.isHigherOrEqual();
    }
}
